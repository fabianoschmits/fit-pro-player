...
const KEYS = [
  ...
  'How should we call you?', 'Enter your name to continue.', 'Your avatar', 'Choose your avatar',
  'Pick the character that will represent you in the app. You can change it whenever you want.',
  'Available avatars', 'Avatar {0} of {1}', 'About you', 'Your body profile',
  'The body diagram adapts to your selection and is used in your statistics.', 'Date of birth', 'Sex',
  'The body map and body statistics follow this selection.', 'Day', 'Month', 'Year', 'Selected date: {0}',
...
const PT = {
  ...
  'Pick the character that will represent you in the app. You can change it whenever you want.': 'Escolha o personagem que vai representar você no aplicativo. Você poderá alterá-lo quando quiser.',
  'Available avatars': 'Avatares disponíveis',
  'Avatar {0} of {1}': 'Avatar {0} de {1}',
  ...
  'Sex': 'Sexo',
  'The body map and body statistics follow this selection.': 'O mapa corporal e as estatísticas corporais acompanham esta escolha.',
  'Day': 'Dia',
  'Month': 'Mês',
  'Year': 'Ano',
