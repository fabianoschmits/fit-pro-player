...
export default function InviteLanding() {
  ...
  const accept = async () => { setError(''); try { await repo.acceptInvite(code); sessionStorage.removeItem('fpp-pending-invite'); setMessage('Vínculo criado.'); navigate('/student/professionals', { replace: true }) } catch { setError('Não foi possível aceitar este convite. Ele pode ter expirado ou já ter sido utilizado.') } }
