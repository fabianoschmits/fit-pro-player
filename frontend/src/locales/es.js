...
export default {
  ...
  'Tap an exercise to preview it before choosing.': 'Toca un ejercicio para verlo antes de elegirlo.',
  'Rest today': 'Descanso hoy',
  'Next workout': 'Próximo entrenamiento',
  'Start another workout': 'Empezar otro entrenamiento',
  ...
  'Create a plan for today': 'Crear un plan para hoy',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Fit Pro Player localmente en este dispositivo.',
  ...
  'to install Fit Pro Player as a full-screen app.': 'para instalar Fit Pro Player como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': 'Avisos del temporizador de descanso, incluso con Fit Pro Player cerrado.',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Fit Pro Player: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'this isn’t an Fit Pro Player plan file': 'esto no es un archivo de plan de Fit Pro Player',
  'Shared routine': 'Rutina compartida',
  'Unknown exercise': 'Ejercicio desconocido',
  'Weekly Training Plan': 'Plan de entrenamiento semanal',
  'Made with Fit Pro Player': 'Hecho con Fit Pro Player',
  ...
  'Reload Fit Pro Player': 'Recargar Fit Pro Player',
  ...
  "Duplicate routine": "Duplicar rutina",
  "Exercise replaced": "Ejercicio sustituido",
  ...
  "Protect your training": "Protege tus entrenamientos", "Create an account to sign in on another device. Your training stays on this device.": "Crea una cuenta para iniciar sesión en otro dispositivo. Tus entrenamientos permanecen en este dispositivo.", "Sign in": "Iniciar sesión", "Create account": "Crear cuenta", "Email": "Correo electrónico", "Password": "Contraseña", "Name": "Nombre", "New password": "Nueva contraseña", "Confirm password": "Confirmar contraseña", "Email or password is incorrect.": "El correo o la contraseña no son correctos.", "An account already uses this email.": "Ya hay una cuenta que usa este correo.", "Choose a stronger password.": "Elige una contraseña más segura.", "Check your connection and try again.": "Comprueba tu conexión e inténtalo de nuevo.", "Account sign-in is unavailable right now.": "El inicio de sesión no está disponible ahora.", "Confirm your email before signing in.": "Confirma tu correo antes de iniciar sesión.", "This recovery link has expired. Request a new one.": "Este enlace de recuperación ha caducado. Solicita uno nuevo.", "This recovery link is invalid. Request a new one.": "Este enlace de recuperación no es válido. Solicita uno nuevo.", "Passwords do not match.": "Las contraseñas no coinciden.", "Check your email to confirm your account.": "Revisa tu correo para confirmar tu cuenta.", "If an account exists for this email, we sent recovery instructions.": "Si existe una cuenta para este correo, enviamos instrucciones de recuperación.", "Recover your password": "Recupera tu contraseña", "Reset password": "Restablecer contraseña", "Send recovery email": "Enviar correo de recuperación", "Forgot password?": "¿Olvidaste tu contraseña?", "Already have an account? Sign in": "¿Ya tienes una cuenta? Inicia sesión", "Need an account? Create one": "¿Necesitas una cuenta? Crea una", "Signed in to your account": "Sesión iniciada en tu cuenta"
}
