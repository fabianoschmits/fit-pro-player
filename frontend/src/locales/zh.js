...
export default {
  ...
  'Create a plan for today': '为今天创建计划',
  ...
  'Delete routine': '删除训练日',
  '{0} exercises in the catalogue': '目录中有 {0} 个动作',
  'Search…': '搜索…',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 Fit Pro Player。',
  ...
  'to install Fit Pro Player as a full-screen app.': '即可将 Fit Pro Player 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': '休息计时提醒，即使 Fit Pro Player 已关闭。',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Fit Pro Player——只有训练日，不包含你的训练记录或体重。',
