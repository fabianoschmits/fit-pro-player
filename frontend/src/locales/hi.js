...
export default {
  ...
  'Tap an exercise to preview it before choosing.': 'चुनने से पहले उसका पूर्वावलोकन देखने के लिए व्यायाम पर टैप करें।',
  'Rest today': 'आज आराम',
  'Next workout': 'अगला वर्कआउट',
  'Start another workout': 'दूसरा वर्कआउट शुरू करें',
  '{0} workout': '{0} वर्कआउट',
  ...
  'Create a plan for today': 'आज के लिए योजना बनाएँ',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर Fit Pro Player लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install Fit Pro Player as a full-screen app.': 'से Fit Pro Player को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': 'आराम टाइमर अलर्ट, Fit Pro Player बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Fit Pro Player में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'this isn’t an Fit Pro Player plan file': 'यह Fit Pro Player प्लान फ़ाइल नहीं है',
  'Shared routine': 'साझा किया गया रूटीन',
  'Unknown exercise': 'अज्ञात व्यायाम',
  'Weekly Training Plan': 'साप्ताहिक ट्रेनिंग प्लान',
  'Made with Fit Pro Player': 'Fit Pro Player से बनाया गया',
  ...
  'Reload Fit Pro Player': 'Fit Pro Player फिर से लोड करें',
  ...
  "Protect your training": "अपने प्रशिक्षण को सुरक्षित रखें", "Create an account to sign in on another device. Your training stays on this device.": "दूसरे डिवाइस पर साइन इन करने के लिए खाता बनाएँ। आपका प्रशिक्षण इस डिवाइस पर ही रहता है।", "Sign in": "साइन इन करें", "Create account": "खाता बनाएँ", "Email": "ईमेल", "Password": "पासवर्ड", "Name": "नाम", "New password": "नया पासवर्ड", "Confirm password": "पासवर्ड की पुष्टि करें", "Email or password is incorrect.": "ईमेल या पासवर्ड गलत है।", "An account already uses this email.": "इस ईमेल का उपयोग पहले से एक खाता कर रहा है।", "Choose a stronger password.": "और मज़बूत पासवर्ड चुनें।", "Check your connection and try again.": "अपना कनेक्शन जाँचें और फिर कोशिश करें।", "Account sign-in is unavailable right now.": "खाता साइन-इन अभी उपलब्ध नहीं है।", "Confirm your email before signing in.": "साइन इन करने से पहले अपना ईमेल पुष्टि करें।", "This recovery link has expired. Request a new one.": "यह पुनर्प्राप्ति लिंक समाप्त हो गया है। नया माँगें।", "This recovery link is invalid. Request a new one.": "यह पुनर्प्राप्ति लिंक अमान्य है। नया माँगें।", "Passwords do not match.": "पासवर्ड मेल नहीं खाते।", "Check your email to confirm your account.": "अपना खाता पुष्टि करने के लिए ईमेल जाँचें।", "If an account exists for this email, we sent recovery instructions.": "अगर इस ईमेल के लिए खाता मौजूद है, तो हमने पुनर्प्राप्ति निर्देश भेज दिए हैं।", "Recover your password": "पासवर्ड पुनर्प्राप्त करें", "Reset password": "पासवर्ड रीसेट करें", "Send recovery email": "पुनर्प्राप्ति ईमेल भेजें", "Forgot password?": "पासवर्ड भूल गए?", "Already have an account? Sign in": "पहले से खाता है? साइन इन करें", "Need an account? Create one": "खाता चाहिए? एक बनाएँ", "Signed in to your account": "आपके खाते में साइन इन है"
}
