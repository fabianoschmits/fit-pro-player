...
export default {
  ...
  'Rest day': '휴식일',
  'Tap an exercise to preview it before choosing.': '운동을 선택하기 전에 탭하여 미리 보세요.',
  'Rest today': '오늘은 휴식',
  'Next workout': '다음 운동',
  'Start another workout': '다른 운동 시작',
  '{0} workout': '운동 {0}회',
  '{0} workouts': '운동 {0}회',
  ...
  'Create a plan for today': '오늘 계획 만들기',
  ...
  '{0} exercises in the catalogue': '카탈로그에 운동 {0}개',
  'Search…': '검색…',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": '이 브라우저는 패스키를 지원하지 않아요 — 그래도 이 기기에서 Fit Pro Player을 로컬로 사용할 수 있습니다.',
  ...
  'to install Fit Pro Player as a full-screen app.': '하면 Fit Pro Player을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': 'Fit Pro Player이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': '친구가 자신의 Fit Pro Player으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
  ...
  "Protect your training": "운동 기록 보호", "Create an account to sign in on another device. Your training stays on this device.": "다른 기기에서 로그인할 수 있도록 계정을 만드세요. 운동 기록은 이 기기에 남습니다.", "Sign in": "로그인", "Create account": "계정 만들기", "Email": "이메일", "Password": "비밀번호", "Name": "이름", "New password": "새 비밀번호", "Confirm password": "비밀번호 확인", "Email or password is incorrect.": "이메일 또는 비밀번호가 올바르지 않습니다.", "An account already uses this email.": "이 이메일을 사용하는 계정이 이미 있습니다.", "Choose a stronger password.": "더 강력한 비밀번호를 선택하세요.", "Check your connection and try again.": "연결을 확인하고 다시 시도하세요.", "Account sign-in is unavailable right now.": "현재 계정 로그인을 사용할 수 없습니다.", "Confirm your email before signing in.": "로그인하기 전에 이메일을 확인하세요.", "This recovery link has expired. Request a new one.": "이 복구 링크는 만료되었습니다. 새 링크를 요청하세요.", "This recovery link is invalid. Request a new one.": "이 복구 링크는 유효하지 않습니다. 새 링크를 요청하세요.", "Passwords do not match.": "비밀번호가 일치하지 않습니다.", "Check your email to confirm your account.": "계정을 확인하려면 이메일을 확인하세요.", "If an account exists for this email, we sent recovery instructions.": "이 이메일에 해당하는 계정이 있으면 복구 안내를 보냈습니다.", "Recover your password": "비밀번호 복구", "Reset password": "비밀번호 재설정", "Send recovery email": "복구 이메일 보내기", "Forgot password?": "비밀번호를 잊으셨나요?", "Already have an account? Sign in": "이미 계정이 있나요? 로그인", "Need an account? Create one": "계정이 필요하신가요? 만드세요", "Signed in to your account": "계정에 로그인했습니다"
}
