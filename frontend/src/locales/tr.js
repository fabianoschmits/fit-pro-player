...
export default {
  ...
  'Create a plan for today': 'Bugün için plan oluştur',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Fit Pro Player’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': 'Fit Pro Player kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Fit Pro Player\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  "Protect your training": "Antrenmanlarını koru", "Create an account to sign in on another device. Your training stays on this device.": "Başka bir cihazda oturum açmak için hesap oluştur. Antrenmanların bu cihazda kalır.", "Sign in": "Oturum aç", "Create account": "Hesap oluştur", "Email": "E-posta", "Password": "Parola", "Name": "Ad", "New password": "Yeni parola", "Confirm password": "Parolayı onayla", "Email or password is incorrect.": "E-posta veya parola yanlış.", "An account already uses this email.": "Bu e-postayı kullanan bir hesap zaten var.", "Choose a stronger password.": "Daha güçlü bir parola seç.", "Check your connection and try again.": "Bağlantını kontrol et ve tekrar dene.", "Account sign-in is unavailable right now.": "Hesapla oturum açma şu anda kullanılamıyor.", "Confirm your email before signing in.": "Oturum açmadan önce e-postanı onayla.", "This recovery link has expired. Request a new one.": "Bu kurtarma bağlantısının süresi doldu. Yeni bir tane iste.", "This recovery link is invalid. Request a new one.": "Bu kurtarma bağlantısı geçersiz. Yeni bir tane iste.", "Passwords do not match.": "Parolalar eşleşmiyor.", "Check your email to confirm your account.": "Hesabını onaylamak için e-postanı kontrol et.", "If an account exists for this email, we sent recovery instructions.": "Bu e-posta için bir hesap varsa kurtarma talimatlarını gönderdik.", "Recover your password": "Parolanı kurtar", "Reset password": "Parolayı sıfırla", "Send recovery email": "Kurtarma e-postası gönder", "Forgot password?": "Parolanı mı unuttun?", "Already have an account? Sign in": "Zaten hesabın var mı? Oturum aç", "Need an account? Create one": "Hesaba mı ihtiyacın var? Oluştur", "Signed in to your account": "Hesabında oturum açıldı"
}
