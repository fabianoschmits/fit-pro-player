...
export default {
  ...
  'Tap an exercise to preview it before choosing.': 'Нажмите на упражнение, чтобы посмотреть его перед выбором.',
  'Rest today': 'Сегодня отдых',
  'Next workout': 'Следующая тренировка',
  'Start another workout': 'Начать другую тренировку',
  ...
  'Create a plan for today': 'Создать план на сегодня',
  ...
  'Delete routine': 'Удалить программу',
  '{0} exercises in the catalogue': '{0} упражнений в каталоге',
  'Search…': 'Поиск…',
  ...
  "This browser doesn't support passkeys — you can still use Fit Pro Player locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Fit Pro Player можно использовать локально на этом устройстве.',
  ...
  'to install Fit Pro Player as a full-screen app.': 'чтобы установить Fit Pro Player как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if Fit Pro Player is closed.': 'Оповещения таймера отдыха, даже если Fit Pro Player закрыт.',
  ...
  'A small file a friend imports into their own Fit Pro Player — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Fit Pro Player — только программы, без твоих тренировок и взвешиваний.',
  ...
  'this isn’t an Fit Pro Player plan file': 'это не файл плана Fit Pro Player',
  'Shared routine': 'Общая программа',
  'Unknown exercise': 'Неизвестное упражнение',
  'Weekly Training Plan': 'Недельный план тренировок',
  'Made with Fit Pro Player': 'Сделано в Fit Pro Player',
  ...
  'Reload Fit Pro Player': 'Перезагрузить Fit Pro Player',
  ...
  "Total Volume Lifted": "Общий поднятый вес",
  ...
  "Protect your training": "Защитите тренировки", "Create an account to sign in on another device. Your training stays on this device.": "Создайте аккаунт, чтобы войти на другом устройстве. Ваши тренировки остаются на этом устройстве.", "Sign in": "Войти", "Create account": "Создать аккаунт", "Email": "Эл. почта", "Password": "Пароль", "Name": "Имя", "New password": "Новый пароль", "Confirm password": "Подтвердите пароль", "Email or password is incorrect.": "Эл. почта или пароль неверны.", "An account already uses this email.": "Этот адрес эл. почты уже используется.", "Choose a stronger password.": "Выберите более надёжный пароль.", "Check your connection and try again.": "Проверьте подключение и попробуйте снова.", "Account sign-in is unavailable right now.": "Вход в аккаунт сейчас недоступен.", "Confirm your email before signing in.": "Подтвердите эл. почту перед входом.", "This recovery link has expired. Request a new one.": "Срок действия ссылки восстановления истёк. Запросите новую.", "This recovery link is invalid. Request a new one.": "Ссылка восстановления недействительна. Запросите новую.", "Passwords do not match.": "Пароли не совпадают.", "Check your email to confirm your account.": "Проверьте эл. почту, чтобы подтвердить аккаунт.", "If an account exists for this email, we sent recovery instructions.": "Если аккаунт для этой эл. почты существует, мы отправили инструкции по восстановлению.", "Recover your password": "Восстановить пароль", "Reset password": "Сбросить пароль", "Send recovery email": "Отправить письмо для восстановления", "Forgot password?": "Забыли пароль?", "Already have an account? Sign in": "Уже есть аккаунт? Войдите", "Need an account? Create one": "Нужен аккаунт? Создайте его", "Signed in to your account": "Вы вошли в аккаунт"
}
