// Fit Pro Player icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  ruler: <><path d="m5.1 17.5 12.4-12.4a1.4 1.4 0 0 1 2 0l.4.4a1.4 1.4 0 0 1 0 2L7.5 19.9a1.4 1.4 0 0 1-2 0l-.4-.4a1.4 1.4 0 0 1 0-2Z" /><path d="m14.5 8.1 1.7 1.7M11.9 10.7l1.2 1.2M9.3 13.3l1.7 1.7M6.7 15.9l1.2 1.2" /></>,
