...
const requiredFiles = [
  ...
  'supabase/migrations/202609240012_professional_management_rpc.sql',
  'supabase/tests/202609240012_professional_management_rpc.sql',
]
...
test('rejects missing reproducibility files', () => {
  ...
  try {
    ...
    assert.deepEqual(violations, [
      ...
      'missing required file: supabase/migrations/202609240007_account_lifecycle.sql',
      ...
      'missing required file: supabase/migrations/202609240012_professional_management_rpc.sql',
      'missing required file: supabase/tests/202609240012_professional_management_rpc.sql',
    ])
  } finally {
